...
![Version](https://img.shields.io/badge/version-v0.4.0-pre-v2-closure.1-blue.svg)
...
You do not need a complete worldbook to start. In v0.4.0-pre-v2-closure.1, you can paste material first, create a draft world, and later organize characters, worldbook entries, review records, and export packages.
...
> The plugin system is deferred and is not part of the v0.4.0-pre-v2-closure.1 product scope. Some internal scaffolding may remain in the repository, but the default UI should not expose plugin entry points, and users should not rely on plugin functionality in this version.
