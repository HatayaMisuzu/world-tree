...
| PLAYABLE | A specific entry has all three evidence records: Tier-1 real LLM smoke PASS, at least one human playtest record, and at least one screen recording of 60 seconds or longer. This status must be signed by a human maintainer. | Agent-only validation, mock-provider smoke, local fallback, or engineering closure. |
