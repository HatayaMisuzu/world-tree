# Historical World Tree Desktop v2.2.0 — 发布检查清单

> Archived legacy release checklist. It is retained only as historical evidence and is not a current release contract.
