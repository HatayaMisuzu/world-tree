...
| [PROJECT_FACTS.md](PROJECT_FACTS.md) | Generated commit, version, test, and package facts |
...
- **Trusted baseline**: `v0.5.0-product-experience-rebuild.0` machine facts
- **Current branch**: generated by `npm run facts:generate`
- **Latest audited commit**: generated in `output/project-facts.json`
...
| [EXPERIENCE_WORKSPACE.md](product/EXPERIENCE_WORKSPACE.md) | 共享体验循环、消息语义、流式中止与黄金路径 |
