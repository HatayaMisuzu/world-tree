...
export const MODE_MODULE_MAP = Object.freeze({
  ...
  character: Object.freeze(["core.world_container", "character.preset", "character.cognition", "character.card_runtime", "scene.session", "audit.narrative_quality", "core.dynamic_state"]),
  "murder-mystery": Object.freeze(["mystery.case", "mystery.phase", "mystery.clue", "mystery.testimony", "mystery.truth_lock", "mystery.scoring", "character.preset"]),
  tabletop: Object.freeze(["core.world_container", "lore.worldbook_trigger", "core.dynamic_state", "scene.session", "rule.world_rule", "audit.narrative_quality", "time.timeline", "event.random_event", "prediction.scene_direction", "trpg.dice", "trpg.check", "trpg.character_sheet", "trpg.clock"]),
  "mystery-puzzle": Object.freeze(["core.world_container", "scene.session", "puzzle.scene", "mystery.clue", "rule.world_rule", "audit.narrative_quality", "core.dynamic_state"]),
  "world-rpg": Object.freeze(["core.world_container", "lore.worldbook_trigger", "core.dynamic_state", "entity.relationship_network", "entity.key_character", "character.preset", "character.cognition", "scene.session", "narrative.story_template", "narrative.five_layer_engine", "rule.world_rule", "audit.narrative_quality", "time.timeline", "event.random_event", "prediction.scene_direction", "rpg.quest", "rpg.bond", "rpg.chapter", "rpg.growth"]),
  "strategy-sim": Object.freeze(["core.world_container", "core.dynamic_state", "entity.organization", "entity.organization_hierarchy", "entity.relationship_network", "time.timeline", "event.random_event", "strategy.resource", "strategy.calendar", "strategy.decision", "strategy.faction", "strategy.diplomacy", "strategy.turn", "strategy.loyalty", "audit.narrative_quality"]),
