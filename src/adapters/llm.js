...
${joinPromptSafetyClauses("jsonOnly", "localPrivacy", "hiddenTruth", "proposalCanonBoundary", "productPublicView", "featureFocus", "oocGuard", "antiHallucination")}`;
...
${joinPromptSafetyClauses("localPrivacy", "hiddenTruth", "proposalCanonBoundary", "productPublicView", "featureFocus", "oocGuard", "antiHallucination")}`;
